"""
Django settings for Systemtest project.
...
SECRET_KEY = '4r%(y$i6m(#6f$qy5d$u5(6^5y@7l=(5go#wu#z^ot2d2h2$(z'
...
WSGI_APPLICATION = 'Systemtest.wsgi.application'
